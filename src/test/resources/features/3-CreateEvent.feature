Feature:
  ...
  Scenario:10. User should be able to add attendees by selecting contacts individually or adding grups and departments.
  Scenario:11. Useer should be able to click on More to specify the event details.